...
import { Slide07AppropiaHours } from "@/components/slides/slide-07-appropia-hours";
import { Slide08AppropiaSlas } from "@/components/slides/slide-08-appropia-slas";
  ...
  return (
    <>
      <main className="snap-deck">
        ...
        <Slide02Executive index={2} total={TOTAL} />
        <Slide03Team index={3} total={TOTAL} />
        <Slide04Product index={4} total={TOTAL} />
        <Slide05TicketFlow index={5} total={TOTAL} />
        <Slide06TicketCategories index={6} total={TOTAL} />
        <Slide07AppropiaHours index={7} total={TOTAL} />
        <Slide08AppropiaSlas index={8} total={TOTAL} />
        <Slide09Offenders index={9} total={TOTAL} />
        <Slide10Mitigations index={10} total={TOTAL} />
        <Slide11Requests index={11} total={TOTAL} />
        <Slide12Transition index={12} total={TOTAL} />
        <Slide13Next90 index={13} total={TOTAL} />
        <Slide14Closing index={14} total={TOTAL} />
      </main>
